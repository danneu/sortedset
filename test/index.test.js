...
test('constructor variants', t => {
  ...
  // Initial array and custom compare
  {
    ...
    t.deepEqual(set.toArray(), [3, 2, 1])
  }
  // Only initial array
  {
    const set = new SortedSet([2, 1, 3])
    t.deepEqual(set.toArray(), [1, 2, 3])
  }
})
...
test('#clear', t => {
  ...
  set.add(100)
  set.add(300)
  t.deepEqual(set.toArray(), [100, 200, 300])
})
